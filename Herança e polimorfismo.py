...
class Jogador(Pessoa):
    ...
    def apresentar(self):
        print(f"Olá, meu nome é {self.nome}, tenho {self.idade} anos, jogo como {self.posicao} e meu número é {self.numero}.")
...
class Tecnico(Pessoa):
    ...
    def apresentar(self):
        print(f"Olá, meu nome é {self.nome}, tenho {self.idade} anos e tenho {self.experiencia} anos de experiência como técnico.")
...
#         else:
#             print("Nenhum técnico contratado.")                     
def apresentar_pessoa(obj):
    obj.apresentar()

objetos = [Jogador(), Tecnico()]
for obj in objetos:
    apresentar_pessoa(obj)    
